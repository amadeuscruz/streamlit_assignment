...
classification_space = st.sidebar.selectbox(
    "Pick a classification method:", cs
)

st.title("NLP Model Deployment")
st.write("This app uses these models for classification: Naive Bayes, SVM, Random Forest, Decision Tree.")
st.write("Results")
...
if st.sidebar.button("Classify"):
    ...
    if classification_space == "Naive Bayes":
        ...
        classificationPipeline = classificationPipeline.fit(
